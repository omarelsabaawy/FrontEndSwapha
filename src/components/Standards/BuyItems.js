...
function BuyItems() {
    ...
    useEffect(() => {
        const fetchPages = async () => {
            try {
                ...
                const productsNumber = await axios.get(`/api/products/buy/numbers/${params.country}`);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const result = await axios.get(`/api/products/buy/${params.country}?page=${currentPage}&perPage=16`);
